...
@section('conteudo')
    ...
    <script>
        ...
        function carregarTimeCampeonatos() {
            ...
            aCabecalho = ['Código',  'Código Campeonato','Campeonato', 'Código Time', 'Time', 'Alterar', 'Remover'];
        ...
        function alterarTimeCampeonato(codigo) {
            $.ajax({
                ...
                success: function(result) {
                    alert('Time x Campeonato alterado com sucesso!');
        ...
        function deletaTimeCampeonato(id) {
            ...
            $.ajax({
                ...
                type: 'DELETE',
                success: function(result) {
                    alert('Time x Campeonato removido com sucesso!');
        ...
        function formulario(id, id_campeonato, id_time) {
            ...
            oH1.innerHTML = bAltera ? 'Alteração do Time x Campeonato': 'Cadastro de Time x Campeonato';
        ...
        function cadastrarTimeCampeonato() {
            $.ajax({
                ...
                data: {timcodigo: document.getElementById('timcodigo').value,
                       camcodigo: document.getElementById('camcodigo').value},
                success: function(result) {
                    alert('Time x Campeonato cadastrado com sucesso!');
                }
            });
